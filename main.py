...
filenames = random.sample(os.listdir('D:\\Msc Computer Science\\Python\\Image Colourisation - Convolutional Neural Network\\Train'), 100) #replace with path of training images
rootdir = os.getcwd()
dir = 'Train'
